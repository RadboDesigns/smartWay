...
<head>
<meta charset="utf-8">
<title>Kashit - Technology & IT Solutions HTML Template | Our Gallery</title>
<!-- Stylesheets -->
...
<div class="page-wrapper">
    ...
    <header class="main-header header-style-three">
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                <div class="nav-logo"><a href="index.php"><img src="assets/images/logo-3.png" alt="" title=""></a></div>
				<!-- Search -->
			...
			<div class="row clearfix">
				...
				<div class="gallery-two_block col-lg-4 col-md-6 col-sm-12">
					<div class="gallery-two_block-inner wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<div class="gallery-two_block-content">
							<div class="gallery-two_block-category">ERP Consulting</div>
							<h4 class="gallery-two_block-heading"><a href="traningServDetail.php">SAP Business One ERP Services</a></h4>
						</div>
					</div>
				</div>
				...
				<div class="gallery-two_block col-lg-4 col-md-6 col-sm-12">
					<div class="gallery-two_block-inner wow fadeInLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
						...
						<div class="gallery-two_block-content">
							<div class="gallery-two_block-category">Field Staff Management APP</div>
							<h4 class="gallery-two_block-heading"><a href="fieldsense.php">FieldSense </a></h4>
						</div>
					</div>
				</div>
				...
				<div class="gallery-two_block col-lg-4 col-md-6 col-sm-12">
					<div class="gallery-two_block-inner wow fadeInLeft" data-wow-delay="600ms" data-wow-duration="1500ms">
						...
						<div class="gallery-two_block-content">
							<div class="gallery-two_block-category">GST Billing Software for Small Businesses
							</div>
							<h4 class="gallery-two_block-heading"><a href="productDetails.php">Vyapar </a></h4>
						</div>
					</div>
				</div>
