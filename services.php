...
<head>
<meta charset="utf-8">
<title>Kashit - Technology & IT Solutions HTML Template | Service's</title>
<!-- Stylesheets -->
	...
	<section class="services-one style-two">
		<div class="auto-container">
			<div class="row clearfix">
				...
				<div class="service-block_one style-two col-lg-4 col-md-6 col-sm-6">
					<div class="service-block_one-inner">
						<div class="service-block_one-upper-box">
							...
							<h4 class="service-block_one-title"><a href="logoSerDetails.php">Logo & Branding</a></h4>
							<div class="service-block_one-text">we specialize in creating unique and memorable logos that embody the essence of your brand. </div>
						</div>
					</div>
				</div>
				...
				<div class="service-block_one style-two col-lg-4 col-md-6 col-sm-6">
					<div class="service-block_one-inner">
						<div class="service-block_one-upper-box">
							...
							<h4 class="service-block_one-title"><a href="wedSer.php">Website Developement</a></h4>
							<div class="service-block_one-text">We build responsive and user-friendly websites that drive engagement and deliver results.</div>
						</div>
					</div>
				</div>
				...
				<div class="service-block_one style-two col-lg-4 col-md-6 col-sm-6">
					<div class="service-block_one-inner">
						<div class="service-block_one-upper-box">
							...
							<h4 class="service-block_one-title"><a href="grapgSer.php">Graphic Designs</a></h4>
							<div class="service-block_one-text">Our graphic design services at Smart Way transform your ideas into visually stunning artwork.</div>
						</div>
					</div>
				</div>
				...
				<div class="service-block_one style-two col-lg-4 col-md-6 col-sm-6">
					<div class="service-block_one-inner">
						<div class="service-block_one-upper-box">
							...
							<h4 class="service-block_one-title"><a href="packagingSer.php">Packaging Desgins</a></h4>
							<div class="service-block_one-text">We craft packaging designs that not only protect your products but also enhance their appeal.</div>
						</div>
					</div>
				</div>
				...
				<div class="service-block_one style-two col-lg-4 col-md-6 col-sm-6">
					<div class="service-block_one-inner">
						<div class="service-block_one-upper-box">
							<div class="service-block_one-icon flaticon-target"></div>
							<h4 class="service-block_one-title"><a href="appSer.php">App Development</a></h4>
							<div class="service-block_one-text">we specialize in creating innovative and user-centric mobile applications that enhance your business's reach and engagement.</div>
						</div>
					</div>
				</div>
				...
				<div class="service-block_one style-two col-lg-4 col-md-6 col-sm-6">
					<div class="service-block_one-inner">
						<div class="service-block_one-upper-box">
							<div class="service-block_one-icon flaticon-infrastructure"></div>
							<h4 class="service-block_one-title"><a href="socialSer.php">Digital Marketing </a></h4>
							<div class="service-block_one-text">We harness the power of social networking to help your brand connect and engage with a wider audience.</div>
						</div>
					</div>
				</div>
                            ...
                            <div class="main-footer_column col-lg-6 col-md-6 col-sm-12">
                                <div class="footer-widget links-widget">
									...
									<ul class="main-footer_list">
                                        ...
                                        <li><a href="wedSer.php">Website Development</a></li>
