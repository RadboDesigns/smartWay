        	...
        	<div class="row clearfix">
                ...
                <div class="content-side col-lg-12 col-md-12 col-sm-12">
					<div class="service-detail">
						<div class="inner-box">
							<div class="image">
								<img src="assets/images/resource/case7.jpg" alt="" />
							</div>
							<div class="lower-content">
								<h3>Website Developement</h3>
								<p>At Smart Way, we build responsive and user-friendly websites that drive engagement and deliver results. Our expert developers use the latest technologies to create custom websites tailored to your business needs. From e-commerce platforms to corporate sites, we ensure your online presence is visually appealing, fast, and secure. Partner with us to elevate your digital footprint and connect with your audience effectively.</p>
								<p>Launch a website that captures your brand, improves your conversion rates, and maximizes your revenue with WebFX, a leading web design agency providing web design services to businesses worldwide. Get pricing now with our free cost calculator or contact us online to speak with a strategist about our website design services.</p>
