...
<div class="page-wrapper">
    ...
    <section class="page-title" style="background-image:url(assets/images/background/3.jpg)">
        <div class="auto-container">
			<h1>Packaging Desgins</h1>
			<ul class="bread-crumb clearfix">
				<li><a href="index.php">Home</a></li>
				<li>Packaging Desgins</li>
			</ul>
        </div>
    </section>
    <!-- End Page Title -->
					...
					<div class="service-detail">
						<div class="inner-box">
							...
							<div class="lower-content">
								<h3>Packaging Desgins</h3>
								<p>At Smart Way, we craft packaging designs that not only protect your products but also enhance their appeal. Our team combines creativity and functionality to create packaging that stands out on the shelves and tells your brand's story. From concept to final product, we ensure that every detail reflects your brand’s identity and attracts your target audience.</p>
								<p>First impressions are so important to any prospective customers. Our graphic design department utilizes the latest cutting edge software to meticulously create designs that will instill confidence while gaining recognition. From custom logos, to stunning business cards and brochures, our design department can help you create an image that your competitors can only dream of.</p>
								<h6>Your Success JOURNEY That We can Provide.</h6>
								<p>With years of industry experience, our team possesses the skills and knowledge to deliver exceptional results across all our services. We understand that every business is unique, which is why we tailor our services to meet your specific needs and objectives. We stay ahead of industry trends and use the latest technologies to provide innovative solutions that drive success. Your satisfaction is our top priority. We work closely with you to ensure your vision is brought to life and exceeds your expectations.</p>
								<div class="row clearfix">
